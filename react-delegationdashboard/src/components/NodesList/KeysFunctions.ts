...
export const getBlsKeysStatus = (dapp: DappState, queued: any[], delegationContract?: string, auctionContract?: string) => {
    const query = new Query({
...
export const getQueueIndex = (blsKey: any,dapp: DappState, stakingContract?: string, auctionContract?: string) => {
    const query = new Query({
        address: new Address(stakingContract),
